...
variable "vm_size" {
  description = "Size of the Azure VM. Standard_B2ats_v2 (2 vCPU, 1GB RAM) is available in Zone 1 in Southeast Asia (~$4.50/mo). Standard_B2als_v2 (2 vCPU, 4GB RAM, ~$18/mo) is also available."
  type        = string
